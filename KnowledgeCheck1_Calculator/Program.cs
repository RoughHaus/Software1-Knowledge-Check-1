...
namespace KnowledgeCheck1_Calculator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Hello. Press 1 for addition, 2 for subtraction, 3 for multiplication, and 4 for division. Enter each integer seperately.");
            ...
            {
                case "1":
                    Console.WriteLine("Enter 2 seperate integers to add");
                ...
                case "2":
                    Console.WriteLine("Enter 2 seperate integers to subtract");
                ...
                case "3":
                    Console.WriteLine("Enter 2 seperate integers to multiply");
                ...
                case "4":
                    Console.WriteLine("Enter 2 seperate integers to divide");
